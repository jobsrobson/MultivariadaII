...
pg = st.navigation([
    ...
    st.Page("pages/acidentes_tempo.py", title="Frotas Mais Novas Geram Menos Acidentes", icon="1️⃣"),
    st.Page("pages/acidentes_regiao.py", title="Frotas Mais Potentes Geram Mais Acidentes", icon="2️⃣"),
